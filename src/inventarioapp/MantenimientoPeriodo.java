 ...
 * @author Documentos
 */
public class MantenimientoPeriodo extends JPanel {
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                MantenimientoPeriodo.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                MantenimientoPeriodo.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                MantenimientoPeriodo.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                MantenimientoPeriodo.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<inventarioapp.Periodo> toRemove = new ArrayList<inventarioapp.Periodo>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            inventarioapp.Periodo p = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(p);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        inventarioapp.Periodo p = new inventarioapp.Periodo();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<inventarioapp.Periodo> merged = new ArrayList<inventarioapp.Periodo>(list.size());
            for (inventarioapp.Periodo p : list) {
    ...
    private java.util.List<inventarioapp.Periodo> list;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MantenimientoPeriodo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new MantenimientoPeriodo());
